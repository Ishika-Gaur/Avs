...
import { Sparkles, Building2, Home, ShieldCheck, Droplet, Wind, CheckCircle, Award } from 'lucide-react';

const CleaningSanitization = () => {
  ...
  const services = [
    {
      ...
      points: [
        "Daily, weekly, or monthly cleaning schedules tailored to your business",
        "Workstation sanitization, floor care, and restroom maintenance",
        "Conference room cleaning, pantry upkeep, and waste management",
        "After-hours or flexible scheduling to avoid business disruption"
      ]
    },
    {
      icon: <Home className="w-12 h-12" />,
      title: "Industrial & Facility Deep Cleaning",
      points: [
        "Heavy-duty cleaning for warehouses, factories, and production units",
        "Machinery degreasing, floor scrubbing, and high-pressure washing",
        "Ceiling, duct, and ventilation system cleaning",
        "Compliance with safety and hygiene standards for industrial environments"
      ]
    },
    {
      ...
      points: [
        "Hospital-grade disinfection using EPA-approved chemicals",
        "Electrostatic spraying and fogging for comprehensive coverage",
        "High-touch surface sanitization (door handles, elevators, workstations)",
        "COVID-19 and pathogen control protocols for public spaces"
      ]
    },
    {
      ...
      points: [
        "Carpet shampooing, upholstery cleaning, and fabric care",
        "Window washing for high-rise buildings and commercial complexes",
        "Post-construction cleanup and move-in/move-out services",
        "Event cleaning for conferences, exhibitions, and corporate gatherings"
      ]
    }
  ];
  ...
  const features = [
    {
      ...
      points: [
        "Background-verified cleaning personnel with professional training",
        "Expertise in handling commercial-grade cleaning equipment",
        "Uniformed staff with ID badges for easy identification",
        "Regular skill development and safety protocol training"
      ]
    },
    {
      ...
      points: [
        "Non-toxic, biodegradable cleaning agents safe for all environments",
        "Green-certified products that minimize environmental impact",
        "Allergen-free solutions suitable for sensitive workspaces",
        "Compliance with health and safety regulations (OSHA, EPA standards)"
      ]
    },
    {
      ...
      points: [
        "Industrial vacuum cleaners, scrubbers, and floor polishers",
        "Electrostatic disinfection equipment for superior sanitization",
        "HEPA filtration systems for air quality improvement",
        "IoT-enabled monitoring for quality assurance and reporting"
      ]
    },
    {
      ...
      points: [
        "Customizable cleaning schedules to fit your operational needs",
        "24/7 availability for emergency cleaning requirements",
        "Dedicated account managers for consistent quality control",
        "100% satisfaction guarantee with performance audits"
      ]
    }
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              <div className="text-white/80 text-sm font-medium tracking-wide animate-slide-down">
                HOME <span className="text-amber-500 mx-2">▸</span> Cleaning & Sanitization Services
              </div>
              ...
              <h2 className="font-display text-2xl lg:text-3xl font-semibold text-amber-500 animate-slide-up" style={{ animationDelay: '0.1s' }}>
                Professional Hygiene Solutions for Healthy, Spotless Environments
              </h2>

              <p className="text-lg text-white/90 leading-relaxed animate-slide-up" style={{ animationDelay: '0.2s' }}>
                At AVS Enterprise, we deliver comprehensive cleaning and sanitization services that create safe, hygienic, and welcoming spaces. From commercial offices to industrial facilities, our trained professionals use eco-friendly products and advanced equipment to ensure the highest standards of cleanliness and health protection.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16" id="animate-services">
            <h2 className="font-display text-4xl lg:text-5xl font-bold text-slate-900 mb-4">
              Our Cleaning & Sanitization Solutions Include:
            </h2>
          </div>
      ...
      <section className="relative py-20 cta-gradient overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-white/90 mb-8 leading-relaxed">
            Partner with AVS Enterprise for professional cleaning and sanitization services that ensure safety, hygiene, and peace of mind.
          </p>
...
export default CleaningSanitization;